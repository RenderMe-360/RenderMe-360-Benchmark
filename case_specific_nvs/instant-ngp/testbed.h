...
public:
	...
	void set_camera_to_view(const Eigen::Matrix<float, 3, 4>& cam, const Eigen::Vector2f& focal_length, const Eigen::Vector2i& resolution, const Eigen::Vector4f& distortion, const Eigen::Vector2f& principal_point);
	void reset_camera();
	bool keyboard_event();
