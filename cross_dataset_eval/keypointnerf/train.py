...
if __name__ == "__main__":
    ...
    # create model 
    if "multiface" in args.config and "multiface" in cfg['expname']:
        model = config.get_model_multiface(cfg)
        print("load multiface model")
    elif "facescape" in args.config and "facescape" in cfg['expname']:
        model = config.get_model_facescape(cfg)
        print("load facescape model")
    else:
        model = config.get_model(cfg)
        print("load renderme model")
