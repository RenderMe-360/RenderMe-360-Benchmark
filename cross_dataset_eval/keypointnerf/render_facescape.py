...
from src.model_facescape import KeypointNeRFLightningModule
from src.facescape_dataset import FacescapeDataset
...
if __name__ == "__main__":
    ...
    test_dataset = FacescapeDataset.from_config(cfg['dataset'], 'val_unseen_id', cfg)
    ...
    renderer.test_facescape(data_loader, label=args.renface_split.replace('/', ':'))
