...
def train():
    ...
    if not basedir.startswith('/mnt'):
        abspath = os.path.dirname(os.path.abspath(__file__))
        basedir = f'{abspath}/../{basedir}'
    # args.expname = args.expname + '_F%02d-%02d'%(args.start_frame, args.end_frame) #TODO
    ...
    if args.render_lockcam_slowmo: # 84 * 288
